...
| ![Star count](https://flat.badgen.net/github/stars/yuki-ycino/fzf-preview.vim?label=★&color=black) |[fzf-preview.vim](https://github.com/yuki-ycino/fzf-preview.vim) [:page_facing_up:](plug_plugins/fzf-preview.vim)|The plugin that powerfully integrates fzf and (Neo)vim. It is also possible to integrate with coc.nvim. |
...
_Generated by `rake update_readme` on 2021/03/16._
